...
namespace PlayFab
{
    ...
    public static class PlayFabClientAPI
    {
        ...
        internal static void GetUserInventory(GetUserInventoryRequest getUserInventoryRequest, Action<GetUserInventoryResult> p, Action<PlayFabError> onGetCurrency, object onGetCurrencyError)
        {
